...
<script>
  import {GetDepartment,UpdateDepartment,DeleteDepartment} from "../api/hrmDepartment";
  ...
  export default {
      ...
      methods:{
          UpdateTableData(){
              ...
              GetDepartment(temp).then(function (e) {
                  if(e.status=='ok'){
          ...
          EditUser(formName){
              ...
              this.$refs[formName].validate((valid) => {
                  if (valid) {
                      UpdateDepartment(that.editForm).then(function (e) {
                          if(e.status=='ok'){
                              that.$message({
                                  message:'修改成功',
                                  type:'success'
          ...
          DeleteUserClick(){
              ...
              that.$alert('是否删除选中的条目', '删除提示', {
                  ...
                  callback: action => {
                      if(action=='confirm'){
                          DeleteDepartment(tempArray).then(function (e) {
                              if(e.status=='ok'){
                                  that.$message({
                                      message:'删除成功',
                                      type:'success'
